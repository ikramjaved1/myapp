...
class PhysiciansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create physician" do
    assert_difference("Physician.count") do
      post physicians_url, params: { physician: { dname: @physician.dname, experience: @physician.experience } }
    end
  ...
  test "should update physician" do
    patch physician_url(@physician), params: { physician: { dname: @physician.dname, experience: @physician.experience } }
